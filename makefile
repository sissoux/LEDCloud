...
UPL_PJRC_B       := C:\arduino-1.8.9\hardware\tools
UPL_TYCMD_B      := C:\arduino-1.8.9\hardware\tools
...
DEFINES     := -D__MK20DX256__ -DTEENSYDUINO=147 -DARDUINO=10807
